...
namespace Inworld.Studio
{
    ...
    public class RuntimeInworldStudio : SingletonBehavior<RuntimeInworldStudio>, IStudioDataHandler
    {
        ...
        InworldSceneData _CreateInworldScene(Scene scene)
        {
            ...
            foreach (var charRef in scene.CharacterReferences)
            {
                inst.characters.Add(charRef.Character);
            }
            m_Event.Invoke(StudioStatus.ListAScene, inst.fullName);
            return inst;
        }
        InworldCharacterData _CreateCharacter(Character character)
        {
            ...
            foreach (var trigger in character.BrainTriggers)
            {
                inst.triggers.Add(trigger.Trigger);
            }
            ...
            m_Event.Invoke(StudioStatus.ListACharacter, inst.brain);
            return inst;
        }
        ...
        public async void Init(string tokenForExchange) => await m_Studio.GetUserToken(tokenForExchange);
        /// <summary>
        ...
        public async void CreateWorkspaces(List<Workspace> workspaces)
        {
            ...
            foreach (Workspace ws in workspaces)
            {
                ...
                m_Event.Invoke(StudioStatus.ListWorkspaceCompleted, ws.Name);
            }
        ...
        public void CreateScenes(InworldWorkspaceData workspace, List<Scene> scenes)
        {
            ...
            m_Event.Invoke(StudioStatus.ListSceneCompleted, workspace.title);
        }
        ...
        public void CreateCharacters(InworldWorkspaceData workspace, List<Character> characters)
        {
            ...
            foreach (Character character in characters)
            {
                ...
                InworldAI.User.Characters[character.Name] = _CreateCharacter(character);
                workspace.characters.Add(InworldAI.User.Characters[character.Name]);
            }
            m_Event.Invoke(StudioStatus.ListCharacterFailed, workspace.title);
        }
        ...
        public void OnStudioError(StudioStatus studioStatus, string msg) => m_Event.Invoke(studioStatus, msg);
