...
namespace Inworld
{
    public class InworldCharacter : MonoBehaviour
    {
        ...
        PacketId m_CurrentlyPlayingUtterance = null;
        string m_LastInteraction = null;
        ILipAnimations m_LipAnimation;
        Interactions m_Interactions = new Interactions(6);
        #endregion
        ...
        void OnAudioFinished()
        {
            ...
            if (m_BodyAnimation)
                m_BodyAnimation.HandleEmotion(SpaffCode.Neutral);
            if (m_HeadAnimation)
                m_HeadAnimation.HandleEmotion(SpaffCode.Neutral);
        ...
        /// </param>
        public void LoadCharacter(InworldCharacterData incomingData, GameObject model = null)
        {
            m_Data = incomingData;
        ...
        {
            SendEventToAgent(new TextEvent()
            {
                Text = text,
