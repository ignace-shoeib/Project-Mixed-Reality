...
using Type = Inworld.Grpc.GestureEvent.Types.Type;
...
namespace Inworld.Model
{
    ...
    public class BodyAnimation : MonoBehaviour, InworldAnimation
    {
        ...
        void OnAudioStarted(PacketId id) => HandleMainStatus(AnimMainStatus.Talking);
        
        void OnAudioFinished() => HandleMainStatus(AnimMainStatus.Neutral);
        #endregion
        ...
        public void HandleMainStatus(AnimMainStatus status) => Animator.SetInteger(s_Motion, (int)status);
        /// <summary>
        ...
        public void HandleEmotion(SpaffCode spaffCode)
        {
            ...
            switch (spaffCode)
            {
                case SpaffCode.Neutral:
                    Animator.SetInteger(s_Emotion, (int)Emotion.Neutral);
                    Animator.SetInteger(s_Gesture, (int)Gesture.Neutral);
                    break;
                case SpaffCode.Affection:
                case SpaffCode.Interest:
                    Animator.SetInteger(s_Emotion, (int)Emotion.Happy);
                    break;
                case SpaffCode.Humor:
                case SpaffCode.Joy:
                    Animator.SetInteger(s_Emotion, (int)Emotion.Happy);
                    break;
                case SpaffCode.Contempt:
                case SpaffCode.Belligerence:
                case SpaffCode.Domineering:
                case SpaffCode.Criticism:
                case SpaffCode.Anger:
                case SpaffCode.Defensiveness:
                    Animator.SetInteger(s_Emotion, (int)Emotion.Angry);
                    break;
                case SpaffCode.Tension:
                    Animator.SetInteger(s_Emotion, (int)Emotion.Fear);
                    break;
                case SpaffCode.Stonewalling:
                    Animator.SetInteger(s_Emotion, (int)Emotion.Fear);
                    break;
                case SpaffCode.TenseHumor:
                    Animator.SetInteger(s_Emotion, (int)Emotion.Fear);
                    break;
                case SpaffCode.Whining:
                    Animator.SetInteger(s_Emotion, (int)Emotion.Sad);
                    break;
                case SpaffCode.Sadness:
                    Animator.SetInteger(s_Emotion, (int)Emotion.Sad);
                    break;
                case SpaffCode.Validation:
                    Animator.SetInteger(s_Gesture, (int)Gesture.Confuse);
                    break;
                case SpaffCode.Disgust:
                    Animator.SetInteger(s_Gesture, (int)Gesture.Disgusted);
                    break;
                case SpaffCode.Surprise:
        ...
        public void HandleGesture(Type gesture)
        {
            Animator.SetFloat(s_Random, Random.Range(0, 1) > 0.5f ? 1 : 0);
            Animator.SetFloat(s_RemainSec, m_InworldCharacter.CurrentAudioRemainingTime);
            switch (gesture)
