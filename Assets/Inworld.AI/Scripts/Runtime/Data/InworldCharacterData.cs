...
namespace Inworld.Util
{
    ...
    public class InworldCharacterData : ScriptableObject
    {
        ...
        /// </summary>
        public Texture2D Thumbnail => defaultThumbnail 
            ? defaultThumbnail 
            : string.IsNullOrEmpty(previewImgUri)
            ? InworldAI.Settings.DefaultThumbnail
            : Resources.Load<Texture2D>($"{InworldAI.User.Name}/{InworldAI.Settings.ThumbnailPath}/{CharacterName}");
