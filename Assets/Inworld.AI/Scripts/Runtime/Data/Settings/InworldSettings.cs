...
namespace Inworld.Util
{
    ...
    public class InworldSettings : ScriptableObject
    {
        ...
        [SerializeField] bool m_EnableVerboseLog = false;
        [SerializeField] bool m_EnableSharedCharacters = true;
        [SerializeField] bool m_UseMLAnimation = false;
        #endregion
        ...
        /// </summary>
        public bool UseMLAnimation => m_UseMLAnimation;
        /// <summary>
