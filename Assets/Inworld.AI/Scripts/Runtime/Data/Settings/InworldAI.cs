...
namespace Inworld.Util
{
    ...
    public class InworldAI : ScriptableObject
    {
        ...
        public static void Log(string log) => InworldLog.Log(log);
        /// <summary>
        /// Send warning type of debug log.
        /// If IsVerboseLog is checked, it'll also be displayed in console. 
        /// </summary>
        /// <param name="log">log to send</param>
        public static void LogWarning(string log) => InworldLog.LogWarning(log);
        /// <summary>
        /// Send error type of debug log.
        /// If IsVerboseLog is checked, it'll also be displayed in console. 
        /// </summary>
        /// <param name="log">log to send</param>
        public static void LogError(string log) => InworldLog.LogError(log);
        #endregion
    }
}
