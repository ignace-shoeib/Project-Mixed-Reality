...
namespace Inworld.Editor
{
    ...
    public partial class InworldEditor : IStudioDataHandler
    {
        ...
        async void ListWorkspace() => await m_Studio.ListWorkspace();
        internal async void ListScenes(InworldWorkspaceData ws) => await m_Studio.ListScenes(ws);
        internal async void ListAPIKey(InworldWorkspaceData ws) => await m_Studio.ListAPIKey(ws);
        internal async void ListCharacters(InworldWorkspaceData ws) => await m_Studio.ListCharacters(ws);
